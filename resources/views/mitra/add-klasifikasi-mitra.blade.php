...
@section('content')
    <section class="dark:bg-gray-900 lg:mt-0">
        <div class="bg-white py-8 px-8 mx-auto max-w-4xl rounded border mt-1">
            ...
            @endif
            <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Tambah Klasifikasi Mitra</h2>
            <form action="/mitra/add-klasifikasi" method="post">
                @csrf
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        <label for="klasifikasi"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Klasifikasi Mitra</label>
                        <input type="text" name="klasifikasi" id="klasifikasi"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Masukkan klasifikasi mitra">
                    </div>
                </div>
                <button type="submit"
